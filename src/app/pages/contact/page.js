  ...
  const faqs = [
    {
      ...
      answer: "We offer comprehensive educational programs in Forex trading, stock market analysis, technical analysis, fundamental analysis, risk management, and trading psychology. All programs are designed for educational purposes only."
    },
    {
      question: "Do you provide financial advice or trading signals?",
      answer: "No. NUPIPS is strictly an educational platform. We do not provide financial advice, investment recommendations, or trading signals. All content is for educational purposes only."
    },
    {
      question: "How can I become a partner institution?",
      answer: "Visit our Academy Partnership Program page to learn about eligibility criteria and benefits. You can submit a partnership application through our contact form or email us at education@nupips.com."
    },
    {
      question: "Are your courses suitable for beginners?",
      answer: "Yes! We offer programs for all levels, from complete beginners to intermediate learners. Our structured curriculum helps you progress at your own pace."
    },
    {
      question: "What certifications do your instructors have?",
      answer: "All our instructors hold professional certifications such as CFA, CMT, FRM, and have extensive real-world experience in financial markets. Visit our Experts page to learn more about our faculty."
    }
  ];
    ...
    <>
      ...
      <div className="contactus-page">
              ...
              <div>
                ...
                <div className="contactus-info-card">
                  ...
                  <div className="contactus-card-content">
                    ...
                    <p className="contactus-card-text-primary">education@nupips.com</p>
                    <p className="contactus-card-text-secondary">We'll respond within 24-48 hours</p>
                  </div>
                </div>
              ...
              <div>
                <div className="contactus-form-card">
                  ...
                  <form>
                    ...
                    <div className="contactus-form-group">
                      <label className="contactus-form-label">
                        Email Address <span className="contactus-required">*</span>
                      </label>
                      <input
                        type="email"
                        className="contactus-form-input"
                    ...
                    <button type="submit" className="contactus-submit-btn">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="contactus-btn-icon">
        ...
        <section className="contactus-inquiries-section">
          <div className="contactus-container">
            <div className="contactus-section-header">
              ...
              <p className="contactus-section-subtitle">Quick answers to frequently asked questions</p>
            </div>
            <div className="contactus-inquiries-grid">
              ...
              <div className="contactus-inquiry-card">
                <h3 className="contactus-inquiry-title">Partnership Opportunities</h3>
                <p className="contactus-inquiry-text">
        ...
        <section className="contactus-faq-section">
          <div className="contactus-container">
            <h2 className="contactus-faq-main-title">Frequently Asked Questions</h2>
            <div className="contactus-faq-container">
              {faqs.map((faq, index) => (
                <div key={index} className="contactus-faq-item">
                  ...
                  <div className={`contactus-faq-answer ${activeFaq === index ? 'show' : ''}`}>
                    <p>{faq.answer}</p>
                  </div>
                </div>
              ))}
        ...
        <section className="contactus-notice-section">
          <div className="contactus-container">
            <div className="contactus-notice-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="contactus-notice-icon">
